...
% Alterando a fonte para se assemelhar a Arial/Calibri, conforme sugerido no modelo doc
\usepackage{helvet}
\renewcommand{\familydefault}{\sfdefault}

\usepackage{hyperref} % Para links no sumário
\usepackage{titlesec} % Para controle fino dos títulos das seções
\usepackage{setspace} % Para espaçamento de linhas

\begin{document}
\onehalfspacing

% --- CABEÇALHO DO RELATÓRIO (IMITANDO O DOC) ---
\begin{center}
...
\noindent \textbf{Bolsista:} ( \quad ) Sim \quad ( \quad ) Não. \\
\textbf{Em caso positivo, informar a modalidade da bolsa:} \hrulefill \\[1cm]
...
% Insira os resultados obtidos com os algoritmos implementados aqui.

\section{Conclusões e perspectivas de trabalhos futuros}
% Insira as suas conclusões finais e os próximos passos.
